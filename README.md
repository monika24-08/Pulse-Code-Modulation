...
# Aim:
 To perfom the pulse code modulation of the given message given using python.
 # Tools Required:
...
```
# Output waveforms:
![image](https://github.com/user-attachments/assets/60d411d7-6b34-4b78-ad10-4fe80585855f)

# Result:
 The Pulse Code Modulation of the given message signal using python is verified.
