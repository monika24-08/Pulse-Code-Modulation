...
# Aim:
 To Perform the Pulse-Code Modulation in the given Message signal using python.
# Tools required
...
```
# Output Waveform:
![image](https://github.com/user-attachments/assets/edd7f743-6318-41fd-bc87-8ad3ec6f9439)
