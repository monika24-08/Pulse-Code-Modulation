...
# Aim:
To perform the pulse code modulation for the given message signal using python.
# Tools required:
...
```
# Output Waveform:
![image](https://github.com/user-attachments/assets/38c79969-d4fb-4496-8dbf-489132f8f72f)

# Result:
The pulse code modulation of the given message signal using python are verified. 
